...
import { ListItem, Avatar, Stack, Typography } from '@bmi/tonic-components-mui';
import { StarIcon, ErrorIcon } from '@bmi/tonic-icons-web';
import type { ListItemState } from '@bmi/tonic-components-mui';
...
const meta = {
  title: 'MUI/Atoms/ListItem/TonicListItem',
  component: ListItem,
  parameters: {
    layout: 'centered',
  },
