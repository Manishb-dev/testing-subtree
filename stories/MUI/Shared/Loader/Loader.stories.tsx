...
import { Loader, Stack, Typography, Box } from '@bmi/tonic-components-mui';
import type { LoaderColor, LoaderSize } from '@bmi/tonic-components-mui';

// ─── Meta ─────────────────────────────────────────────────────────────────────

const meta = {
  title: 'MUI/Shared/Loader/TonicLoader',
  component: Loader,
  parameters: {
    layout: 'centered',
  },
